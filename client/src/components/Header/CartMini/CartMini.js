...
import CardAtMiniCart from '../CardAtMiniCart';
...
const CartMini = ( { goodsAtCart = hardCodedGoodsForCart,...props } ) => {
    const classes = useStyles();
    const subTotal = goodsAtCart.reduce(function(sum, current) {
